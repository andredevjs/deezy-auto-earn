...
async function withdrawFunds({
  amountBtc, toAddress, apiKey, apiSecret,
}) {
...
async function maybeAutoWithdraw({
  apiKey, apiSecret, minWithdrawalSats, address,
}) {
  const {
    lnxBalance, lnxAvailableBalance, btcBalance, btcAvailableBalance,
  } = await getBitcoinWalletBalance({
    apiKey,
    apiSecret,
  });
